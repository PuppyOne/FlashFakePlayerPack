...
export const BEHAVIOR_FUNCTION = {
    ...
    swapMainhandItem : (sim:SimulatedPlayer,player:Player)=>commandManager.run('假人主手物品交换',{player:player,simulatedPlayer: sim}),
    swapInventory : (sim:SimulatedPlayer,player:Player)=>commandManager.run('假人背包交换',{player:player,simulatedPlayer: sim}),
    swapEquipment : (sim:SimulatedPlayer,player:Player)=>commandManager.run('假人装备交换',{player:player,simulatedPlayer: sim}),
    ...
    recycle : (sim:SimulatedPlayer,player:Player)=>commandManager.run('假人资源回收',{player:player,simulatedPlayer: sim}), // item and exp
